...
export default function LoginPage() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex min-h-screen items-center justify-center overflow-y-auto bg-neutral-bg-alt p-4 dark:bg-slate-950 sm:p-6">
      ...
      <div className="relative w-full max-w-[420px] rounded-2xl border border-border-custom bg-white p-8 shadow-2xl dark:bg-slate-900">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-sm text-text-muted">
            Access your custom digital workspace
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={role === "CLUB_ADMIN" ? "admin@teamhub.ma" : "fan@teamhub.ma"}
                  className={`w-full rounded-xl border border-border-custom bg-white py-2.5 pl-10 pr-4 text-sm text-text-dark placeholder-text-muted transition-colors focus:outline-none focus:ring-1 dark:bg-slate-900 dark:text-white ${
                    role === "CLUB_ADMIN"
          ...
          >
            {isPending ? "Verifying..." : `Sign In as ${role === "CLUB_ADMIN" ? "Admin" : "Supporter"}`}
